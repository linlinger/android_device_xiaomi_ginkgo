...
BOARD_GINKGO_DYNAMIC_PARTITION_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_GINKGO_DYNAMIC_PARTITION_LIST := system system_ext product vendor odm
